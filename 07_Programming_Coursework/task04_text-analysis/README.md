[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/ru4UAZSi)
[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=18435492)
# DE0807_24-25P_ENG_PT04

Theoretical material in file lesson.py

# Text analysis

Output samples include text that should be output before/after the result. Don't skip spaces and line breaks.
...
Implement your program in a file called **main.py** .

Your program must prompt the user for a string of text using input.
...
More advanced functions are not necessary, therefore are not allowed in this task.

## About auto grading

This task has 13 tests, first three named t0_x.py check whether functions that calculate symbol count work correctly, these three tests don't give you points, but are used as validation criteria (as in do you get all the points from other tests or not), all other tests named tx.py check for "Grade X" answer.
